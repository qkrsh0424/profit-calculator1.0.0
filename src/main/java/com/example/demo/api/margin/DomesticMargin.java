package com.example.demo.api.margin;
...
public class DomesticMargin {
    ...
    public DomesticMargin(int purchaseCost, int purchaseTransCharge, int sellPrice, int sellTransUnitCharge, int realSellTransUnitCharge, double marketCommitionPercentage){
    ...
    public double getMargin(){
        ...
        double unitMargin = (sellUnitPrice - sellUnitPrice * (marketCommitionPercentage/100) - purchaseUnitCost - realSellTransUnitCharge); // 개당 마진
        return unitMargin;
    }
