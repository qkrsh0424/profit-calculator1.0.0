package com.example.demo.api.calculate;

import java.util.Map;

import com.example.demo.api.calculate.VatKnowSumCalculateHandler;
...
public class VatCalculateAPI {
    @RequestMapping(value="/api/calculate/vat/knowSum", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/api/calculate/vat/knowSupply", method=RequestMethod.POST)
